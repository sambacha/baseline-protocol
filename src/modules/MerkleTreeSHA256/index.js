...
const MerkleTreeSHA256Artifacts = require('../../build/contracts/MerkleTreeSHA256.json')

const Web3 = require('web3')
const BN = Web3.utils.BN
const ZeroClientProvider = require('web3-provider-engine/zero.js')

class MerkleTreeSHA256 {
  constructor (options) {

    this.MerkleTreeSHA256 = null
  ...
  deployContract () {
    ...
    this.MerkleTreeSHA256 = new global.web3.eth.Contract(MerkleTreeSHA256Artifacts.abi, this.address)
  }
  ...
  frontier () {
    return this.MerkleTreeSHA256.methods.frontier(new BN(, 10)).call()
    .then((resp) => {
      return resp
    }).catch((err) => {
      console.error(err)
  ...
  latestRoot () {
    return this.MerkleTreeSHA256.methods.latestRoot().call()
    .then((resp) => {
      return resp
    }).catch((err) => {
      console.error(err)
  ...
  leafCount () {
    return this.MerkleTreeSHA256.methods.leafCount().call()
    .then((resp) => {
      return resp
    }).catch((err) => {
      console.error(err)
  ...
  treeHeight () {
    return this.MerkleTreeSHA256.methods.treeHeight().call()
    .then((resp) => {
      return resp
    }).catch((err) => {
      console.error(err)
  ...
  treeWidth () {
    return this.MerkleTreeSHA256.methods.treeWidth().call()
    .then((resp) => {
      return resp
    }).catch((err) => {
      console.error(err)
  ...
  zero () {
    return this.MerkleTreeSHA256.methods.zero().call()
    .then((resp) => {
      return resp
    }).catch((err) => {
      console.error(err)
...
module.exports = MerkleTreeSHA256
